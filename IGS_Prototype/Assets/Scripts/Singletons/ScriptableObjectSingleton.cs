    ...
    public static T Instance
    {
        get
        {
            if (instance == null)
            {
                ...
                {
                    #if UNITY_EDITOR
                    // It has a tendency to throw this error every second or two, feel free to ignore... its unity being jank
                    Debug.LogError("ScriptableObjectSingleton: No objects found in Resources folder.");
                    #endif
                    return null;
                }
